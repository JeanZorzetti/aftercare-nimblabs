...
heroImage:
  src: "/blog/pexels-7582560.jpg"
  alt: "Beautician administering dermal filler injection to woman's face in aesthetic clinic"
  width: 800
  height: 533
faq:
...
**Cheeks and midface:** Lower swelling than lips, but filler in this area requires the most time to fully integrate — assess at 4 weeks, not 2. The restriction that matters most here is pressure, not swelling: back-sleeping for the first nights protects a deep cheek placement more than any compress does. Full protocol in our [cheek filler aftercare guide](/blog/cheek-filler-aftercare).
